...
// Change this key to display the tour the next time a user opens AsistaBot
...
export default class GuidedTour extends React.Component<Props> {
  ...
  render() {
    const steps = [
      {
        selector: '',
        content: 'Welcome to AsistaBot! This is a quick tour of the most important features.'
      },
      {
      ...
      {
        selector: '',
        content: 'All done. Enjoy building bots! For more information, please refer to the guides on asista.com/'
      }
    ]
